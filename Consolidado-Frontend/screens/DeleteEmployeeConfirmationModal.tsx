...
const DeleteEmployeeConfirmationModal: React.FC<DeleteEmployeeConfirmationModalProps> = ({ employee, onClose, onConfirm }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4" role="dialog" aria-modal="true">
      <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-md flex flex-col text-center animate-fade-in-down">
        ...
        <h2 className="text-xl font-bold text-slate-800 mb-2">Eliminar Empleado</h2>
        <p className="text-slate-600 mb-6 text-sm">
            ¿Está seguro de que desea eliminar permanentemente al empleado con código <span className="font-semibold">{employee.codigo}</span>? Esta acción no se puede deshacer.
        </p>
